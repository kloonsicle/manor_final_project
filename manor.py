...
#admin transport, not for player use, just cause I got sick of moving one room at a time while testing this.
def transport():
	...
	while (done != True):
		...
		if action == "here":
			...
			if check == "coatrack":
				...
				print "  Luckily they had an available ticket for Wednesday, so I will take this one instead."
				print "  I'm sorry for the change in plans, and for arriving early."
				print "  I look forward to seeing you and your family."
				print "  Salutations." 
				print " "
				print "Today is Wednesday! You should probably go tell your father the news when you get a chance."
		...
		while (done != True):		
			...
			if action == "here":
				...
				if check == "couch":
					...
					print "You admire yourself in the mirror for a moment, but then get back to searching." 
				elif check == "mother":
					if dict_of_vars["newsformother"] == False:
